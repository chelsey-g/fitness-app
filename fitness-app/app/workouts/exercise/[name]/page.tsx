...
return (
    ...
    <div className="flex flex-col md:flex-row">
        <div className="md:w-1/2">
            ...
            <div className="mb-4">
                <h2 className="text-xs font-medium text-gray-700">
                    Equipment required: <span className="text-gray-600">{exerciseData[0]?.equipment}</span>
                </h2>
            </div>
            <div className="mb-4">
                <h2 className="text-xs font-medium text-gray-700">
                    Primary Muscle Groups: <span className="text-gray-600">{exerciseData[0]?.muscle}</span>
                </h2>
            </div>
        </div>
        <div className="md:w-1/2 text-center">
            ...
            <button className="py-2 px-4 bg-blue-500 hover:bg-blue-600 text-white rounded-md focus:outline-none mt-5 text-center"
